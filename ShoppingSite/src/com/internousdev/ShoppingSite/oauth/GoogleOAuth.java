...
public class GoogleOAuth {
	...
	public static GoogleOAuthToken token(String code, String redirct) {
		String tokenURL = "https://accounts.google.com/o/oauth2/token?" + "code=" + code
				+ "&grant_type=authorization_code" + "&redirect_uri=" + redirct + "&client_id=" + client_id
	...
	public static String RequestToken(String scope, String redirect) {
		String URL = "https://accounts.google.com/o/oauth2/auth?client_id=" + client_id + "&redirect_uri=" + redirect
				+ "&scope=" + scope + "&response_type=code" + "&access_type=offline" + "&approval_prompt=force"
