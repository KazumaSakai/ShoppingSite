	...
	<c:param name="content">
		...
		<s:else>
			...
			<ul class="pager">
				...
				<c:if test="${ (page + 1) != v }">
					<li onclick="location.href='<s:url action="PurchaseHistoryAction"><s:param name="page" value="v" /><s:param name="searchWords" value="searchWords" /><s:param name="andSearch" value="andSearch" /></s:url>'">
						<s:property value="v" />
					</li>
				</c:if>
				</s:iterator>
